(function(){
    ...
    Ks3.config.AK = 'AKLTU-VNN71MRtaMoQs20EsHsQ';  //TODO： 请替换为您的AK
    Ks3.config.SK = 'OGzRI22qSVZ4/VCuLrjgR8Xll/I9x5GfTcLVrQ6PQAvvomzWhBEJk8rdaCvcIxokHQ=='; //TODO: 测试时请填写您的secret key  注意：前端计算signature不安全
    Ks3.config.protocol = 'https';
    Ks3.config.baseUrl = "ks3.kylin.cloudwalk.work"
    Ks3.config.region = '';
    Ks3.config.bucket = 'ipd-test-ai';
    Ks3.config.prefix = '';
    Ks3.config.chunkSize = 5*1024*1024;
    Ks3.config.retries = 20;
    Ks3.config.currentUploadId = '';
    ...
    ks3UploadUrl = "https://ks3.kylin.cloudwalk.work/";
    ...
    var pluploadOptions = {
        ...
        filters: {
            mime_types : [ //只允许上传图片和zip文件
                { title : "Video files", extensions : "zip,mp4,mov,qt,ts,rmvb,rm,avi,flv,mkv,wmv,mpg,mpeg,m2v,m4v,3gp,3g2,webm,vob,ogv,ogg" }
            ],
