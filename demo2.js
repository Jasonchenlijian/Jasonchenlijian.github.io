!function (e) {
  function t (t) {
    for (var o, a, u = t[0], c = t[1], f = t[2], p = 0, s = []; p <
    u.length; p++) a = u[p], r[a] && s.push(r[a][0]), r[a] = 0
  ...
  a.m = e, a.c = o, a.d = function (e, t, n) {
    ...
    typeof e) for (var o in e) a.d(n, o,
  ...
  18: function (e, t, n) {
    ...
    n.r(t)
    n(14), n(20)
    var o, r, i = n(1), a = n(6), u = n(10), c = n(9), f = n(2), l = n(11),
      p = n(7), s = n(8), b = n(4)
    ...
    function d (e, t, n) {
      return (d = 'undefined' != typeof Reflect && Reflect.get
        ? Reflect.get
        : function (e, t, n) {
          var o = function (
            e, t) {
            for (; !Object.prototype.hasOwnProperty.call(e, t) && null !==
                   (e = w(e));)
            return e
          }(e, t)
          if (o) {
    ...
    var g = new (o = Object(p.a)({x: 4, y: 4}), Object(s.a)(r = o(
      r = function (e) {
        function t () {
      ...
      P = new u.a('Welcome', {color: '#0f070a', size: b.a.isMobile ? .5 : .8})
    P.position.x -= .5 * P.basePosition, g.add(P)
    var _ = ['#4062BB', '#52489C', '#59C3C3', '#F45B69', '#F45B69'].map(
      function (e) {return new i.Color(e)}), S = new (function (e) {
      function t () {
        return O(this, t), v(this, w(t).apply(this, arguments))
      }
      ...
      return j(t, c['a']), n = t, (o = [
        {
          key: 'addLine',
          value: function () {
            d(w(t.prototype), 'addLine', this).
              call(this, {
                length: Object(f.a)(8, 15),
                visibleLength: Object(f.a)(.05, .2),
                position: new i.Vector3(1.5 * (Math.random() - .5),
                  Math.random() - 1, 2 * (Math.random() - .5)).multiplyScalar(
                  Object(f.a)(5, 20)),
                turbulence: new i.Vector3(Object(f.a)(-2, 2), Object(f.a)(0, 2),
                  Object(f.a)(-2, 2)),
    ...
    g.add(S), g.start()
    var x = new TimelineLite({delay: .2, onStart: function () {S.start()}})
    x.to('.overlay', .6, {autoAlpha: 0}), x.fromTo(g.lookAt, 3, {y: -4},
      {y: 0, ease: Power3.easeOut}, '-=0.4'), x.add(P.show, '-=2'), b.a.onHide(
      function (e) {
        var t = new TimelineLite
        t.to(g.lookAt, 2, {y: -6, ease: Power3.easeInOut}), t.add(P.hide,
          0), t.add(S.stop), t.to('.overlay', .5, {autoAlpha: 1, onComplete: e},
          '-=1.5')
      })
  }, 20: function (e, t, n) {},
})